...
public class StudentPrivateState extends PrivateState{
	...
	//we synchronize those methods to avoid concurrent modification of the hashmap.
	//since the computer is checking the students grade in an unregulized way we need to sync the access to the hashmap

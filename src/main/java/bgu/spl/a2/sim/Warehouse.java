...
public class Warehouse {
    ...
    private static class WarehouseHolder{ //warehouse is created as a singleton
    ...
    // this would return the instance of the warehouse and creates one if it doesnt exit

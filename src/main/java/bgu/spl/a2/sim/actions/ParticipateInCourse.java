...
public class ParticipateInCourse extends Action<Boolean> {
    ...
    protected void start() {
        ...
        callback second = new callback() { // this callback would fire after  the student have the grade for the course
            @Override
            public void call() {
                complete(true);
            }
        };
        callback first = new callback() { // this callback would fire after the perquisites were checked
            @Override
            public void call() {
